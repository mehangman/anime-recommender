    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-900/10 via-[#0a0a0a] to-[#0a0a0a] text-white p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-[#111111]/80 backdrop-blur-xl p-8 rounded-3xl border border-gray-800/60 shadow-2xl relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-white/95">Welcome back</h2>
          <p className="text-sm text-gray-400 mt-2">Log in to your account to continue</p>
        </div>
        ...
        {step === 1 ? (
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-white hover:bg-gray-200 text-black font-semibold py-3 rounded-xl transition-colors disabled:opacity-50 flex items-center justify-center gap-2 shadow-lg"
            >
